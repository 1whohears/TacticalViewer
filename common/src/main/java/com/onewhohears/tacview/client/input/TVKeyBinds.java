...
public class TVKeyBinds {
    ...
    public static KeyMapping PAUSE, FORWARD_TEN, BACKWARD_TEN, FORWARD_TICK, BACKWARD_TICK, TOGGLE_TRACK;
    ...
    public static void init() {
        ...
        TOGGLE_TRACK = registerKey("toggle_track", InputConstants.UNKNOWN, "key.categories.tacview");
    }
